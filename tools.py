...
# Файл с классами и функциями, не связанные напрямую с методом FDTD
...
class AnimateFieldDisplay:
    ...
    def drawProbes(self, probesPos: List[int]):
        ...
        # probesPos - список координат датчиков для регистрации временных сигналов (в отсчетах).
...
def Spectrum(signal: float, dt: float, x_max: float):
